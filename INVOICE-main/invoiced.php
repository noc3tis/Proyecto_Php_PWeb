<?php
	...
	$pdf->Cell(116,7,iconv("UTF-8", "ISO-8859-1",date("d/m/Y", strtotime("05-05-2024"))." ".date("h:s A")),0,0,'L');
	...
	$pdf->Cell(90,7,iconv("UTF-8", "ISO-8859-1","Habitacion Doble"),'L',0,'C');
	$pdf->Cell(15,7,iconv("UTF-8", "ISO-8859-1","1"),'L',0,'C');
	$pdf->Cell(25,7,iconv("UTF-8", "ISO-8859-1","$2123 MXN"),'L',0,'C');
	$pdf->Cell(19,7,iconv("UTF-8", "ISO-8859-1","$0.00 USD"),'L',0,'C');
	$pdf->Cell(32,7,iconv("UTF-8", "ISO-8859-1","$2123 MXN"),'LR',0,'C');
	$pdf->Ln(7);
	...
	$pdf->Cell(34,7,iconv("UTF-8", "ISO-8859-1","$2123 MXN"),'T',0,'C');
